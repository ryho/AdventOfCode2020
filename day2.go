...
func day2Step1() error {
	var valid int
	lines := strings.Split(day2Input, "\n")
	for _, line := range lines {
		// Parse the line into the different parts
		...
		fmt.Printf("firstNumber %v secondNumber %v letter %v password %v\n", firstNumber, secondNumber, letter, password)
...
func day2Step2() error {
	...
	for _, line := range lines {
		...
		fmt.Printf("firstNumber %v secondNumber %v letter %v password %v\n", firstNumber, secondNumber, letter, password)
		first := password[firstNumber-1] == letter[0]
		second := password[secondNumber-1] == letter[0]
